<template>
  <div class="fixed inset-0 z-50 flex flex-col bg-background text-foreground transition-colors">
    <!-- Top Bar -->
    <header class="flex items-center justify-between pl-[max(1rem,env(safe-area-inset-left))] pr-[max(1rem,env(safe-area-inset-right))] min-h-14 border-b border-border bg-background/95 backdrop-blur flex-shrink-0 pt-safe">
